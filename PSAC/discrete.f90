...
!----------------------------!
 ...
 open(10,file='log.log',position='append') 
 if (pf==0) then
    write(10,'(2i4,2ES16.8,a,2ES16.8,a,2ES16.8)') a, b, x0/nt, avx(0)/nt, '   ', acr(1:2), '   ', del(1:2)*dw
 else
    write(10,'(2i4,2ES16.8,a,3ES16.8,a,3ES16.8)') a, b, x0/nt, avx(0)/nt, '   ', acr(1:3), '   ', del(1:3)*dw
 endif
 close(10)
